...
"[project]/src/app/api/auth-map/login/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    const role = Object.entries(accounts).find(([, account])=>account.username === username && account.password === password)?.[0];
    ...
    response.cookies.set(role === "admin" ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$map$2d$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MAP_ADMIN_COOKIE"] : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$map$2d$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MAP_DRIVER_COOKIE"], (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$map$2d$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createMapToken"])(role), {
        httpOnly: true,
        sameSite: "lax",
        path: "/",
        maxAge: 60 * 60 * 12
...
//# sourceMappingURL=%5Broot-of-the-server%5D__19z6xn4._.js.map