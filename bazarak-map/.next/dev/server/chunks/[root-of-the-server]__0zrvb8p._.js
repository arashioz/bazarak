...
"[project]/src/app/api/auth-map/check-auth/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        let user = null;
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$map$2d$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isValidMapToken"])(adminToken)) {
            user = {
                id: 'admin-1',
                name: 'مدیر سیستم',
                role: 'admin'
            };
        } else if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$map$2d$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isValidMapToken"])(driverToken)) {
            user = {
                id: 'driver-1',
                name: 'راننده',
                role: 'driver'
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0zrvb8p._.js.map